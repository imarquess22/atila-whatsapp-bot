...
// Cria um cliente mínimo (nome + telefone), no mesmo formato de salvarCliente() do index.html.
// CPF/endereço ficam em branco — o studio completa depois pelo app, se precisar.
async function createClienteMinimo(nome, phoneDigits) {
  const cliente = {
    id: uid(),
    nome,
    cpf: '',
