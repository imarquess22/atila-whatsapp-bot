const { sbGet, naoDeletado } = require('./supabase');

// Busca todas as datas/dias bloqueados cadastrados (feriados, recessos, bloqueios pontuais/parciais).
// Ignora bloqueios excluídos no portal (tombstone) — senão um feriado removido continua
// bloqueando a agenda pro bot mesmo depois de apagado.
